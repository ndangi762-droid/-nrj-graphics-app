(() => {
  ...
  function install() {
    ...
    style.textContent = `
      ...
      #puAccountDrawer{position:absolute;top:0;left:0;width:min(360px,92vw);height:100%;box-sizing:border-box;background:#fff;border-radius:0 28px 28px 0;box-shadow:18px 0 50px rgba(25,35,65,.22);transform:translateX(-105%);transition:transform .34s cubic-bezier(.22,1,.36,1);overflow:auto;padding:22px 18px 28px;color:#17233d}
      ...
      @media(max-width:420px){#puAccountDrawer{width:92vw}}
    `;
    ...
    overlay.innerHTML = `<aside id="puAccountDrawer" aria-label="PRINTUP account menu">
      ...
      <button class="pu-ad-item" type="button" onclick="alert('PRINTUP — Printing business management made simple.')"><span class="pu-ad-ico">ⓘ</span><span><b>About PRINTUP</b><small>Version and product details</small></span><span class="arrow">›</span></button>
